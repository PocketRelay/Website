...
the [Binkw32 Patch](./client/7-binkw32.md) which will bypass this verification step

## Problems joining

:::note
If you are using a Steam copy of the game the standard client may cause connection 
issues so its recommended that you use the [Plugin Client](./client/4-plugin-client-manual.mdx) instead
this is the default client in the "Joining a server" guide (since 14th October 2024)
:::
...
- [Retriever Enabled](./server/4-configuration.md#enabled) 
- [Origin Fetch](./server/4-configuration.md#origin-fetch) 
- [Origin Fetch Data](./server/4-configuration.md#origin-fetch-data)
