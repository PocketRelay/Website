...
guide references using the Installer, if you would prefer to manually add the plugin you can follow the [Plugin Client Manual Install Guide](4-plugin-client-manual.mdx)
:::
