...
connected. Check out the [Plugin Client Guide](./4-plugin-client.mdx) for more details.
:::
...
In the future the plugin client will likely become the default version gaining more features that require deeper access to the games internals
:::
