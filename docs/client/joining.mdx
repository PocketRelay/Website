...
guide for using that at [Plugin Client](./plugin-client)
:::
...
:::note
You only need to do this step when you are first setting up the client, the patch will stick around until you either remove it manually or use the **"Remove patch"** button.

You do **NOT** need to remove this patch to play on the official servers, it will not affect this.
:::

:::note ME3 Tweaks Mod Manager
If you are using ME3 Tweaks Mod Manager and have the Bink Bypass for Mass Effect 3 already then you
can skip this step as they are the same thing.
...
a Binkw32 Bypass for an explaination behind this see the [Client Technical Overview](../technical/client#bink-patch)
...
:::tip
This file should be at `{YOUR GAME FOLDER}/Binaries/Win32/MassEffect3.exe`.
:::
